...
CHECKS = [
    ...
    ('L-9FA33840', 'Option groups', lambda ctx: resource_count(ctx, 'describe_option_groups', 'OptionGroupsList')),
    ...
    ('L-A59F4C87', 'Event subscriptions', lambda ctx: resource_count(ctx, 'describe_event_subscriptions', 'EventSubscriptionsList')),
