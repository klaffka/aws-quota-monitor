...
Implemented measurement availability: **42.14%** of the whole union, or
**72.09%** of the 7,062 quotas whose usage can be counted at all.
...
1,971 quotas are measurable and still uncovered. Sorting them by what their
names describe shows what the remaining work actually is:

| Shape | Quotas | What it would take |
| --- | ---: | --- |
| countable | 706 | the name describes a count; whether an API exposes that inventory has to be checked quota by quota |
