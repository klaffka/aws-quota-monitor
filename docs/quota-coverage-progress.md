...
| --- | ---: | ---: |
| total | 12,081 | 10,398 |
| implemented | 2,618 | 2,076 |
| compatibleMetric | 2,535 | 2,535 |
| covered | 4,999 | 4,457 |
| uncovered | 7,082 | 5,941 |
| unmeasurable | 5,019 | 3,055 |
| measurable | 7,062 | 7,343 |

Implemented measurement availability: **41.38%** of the whole union, or
**70.79%** of the 7,062 quotas whose usage can be counted at all.
...
2,063 quotas are measurable and still uncovered. Sorting them by what their
names describe shows what the remaining work actually is:

| Shape | Quotas | What it would take |
| --- | ---: | --- |
| countable | 894 | the name describes a count; whether an API exposes that inventory has to be checked quota by quota |
