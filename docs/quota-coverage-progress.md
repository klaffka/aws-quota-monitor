...
| --- | ---: | ---: |
| total | 12,081 | 10,398 |
| implemented | 2,449 | 2,076 |
| compatibleMetric | 2,535 | 2,535 |
| covered | 4,830 | 4,457 |
| uncovered | 7,251 | 5,941 |
| unmeasurable | 4,998 | 3,055 |
| measurable | 7,083 | 7,343 |

Implemented measurement availability: **39.98%** of the whole union, or
**68.19%** of the 7,083 quotas whose usage can be counted at all.
