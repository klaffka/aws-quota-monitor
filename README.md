...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,758 of
12,081 catalog quotas with an implemented measurement method (39.38%), including
official metrics, which is 54.45% of the 8,739 measurable quotas. It also lists
