...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,742 of
12,081 catalog quotas with an implemented measurement method (39.25%), including
official metrics, which is 54.26% of the 8,739 measurable quotas. It also lists
