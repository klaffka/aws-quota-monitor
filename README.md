...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,802 of
12,081 catalog quotas with an implemented measurement method (39.75%), including
official metrics, which is 67.80% of the 7,083 measurable quotas. It also lists
