...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,701 of
12,081 catalog quotas with an implemented measurement method (38.91%), including
official metrics, which is 53.79% of the 8,739 measurable quotas. It also lists
