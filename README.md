...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,401 of
12,081 catalog quotas with an implemented measurement method (36.43%), including
official metrics, which is 48.46% of the 9,082 measurable quotas. It also lists
