...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,500 of
12,081 catalog quotas with an implemented measurement method (37.25%), including
official metrics, which is 50.97% of the 8,828 measurable quotas. It also lists
