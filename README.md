...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,835 of
12,081 catalog quotas with an implemented measurement method (40.02%), including
official metrics, which is 68.26% of the 7,083 measurable quotas. It also lists
