...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,456 of
12,081 catalog quotas with an implemented measurement method (36.88%), including
official metrics, which is 50.25% of the 8,867 measurable quotas. It also lists
