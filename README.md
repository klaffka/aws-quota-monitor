...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,516 of
12,081 catalog quotas with an implemented measurement method (37.38%), including
official metrics, which is 51.16% of the 8,828 measurable quotas. It also lists
