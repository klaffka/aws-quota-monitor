...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,873 of
12,081 catalog quotas with an implemented measurement method (40.34%), including
official metrics, which is 68.94% of the 7,068 measurable quotas. It also lists
