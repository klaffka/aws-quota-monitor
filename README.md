...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,484 of
12,081 catalog quotas with an implemented measurement method (37.12%), including
official metrics, which is 50.79% of the 8,828 measurable quotas. It also lists
