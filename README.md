...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,897 of
12,081 catalog quotas with an implemented measurement method (40.53%), including
official metrics, which is 69.28% of the 7,068 measurable quotas. It also lists
