...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,544 of
12,081 catalog quotas with an implemented measurement method (37.61%), including
official metrics, which is 52.00% of the 8,739 measurable quotas. It also lists
