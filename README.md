...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,887 of
12,081 catalog quotas with an implemented measurement method (40.45%), including
official metrics, which is 69.14% of the 7,068 measurable quotas. It also lists
