...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,592 of
12,081 catalog quotas with an implemented measurement method (38.01%), including
official metrics, which is 52.55% of the 8,739 measurable quotas. It also lists
