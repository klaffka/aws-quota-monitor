...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/coverage-72.15%25%20of%20measurable%20quotas-3DBF9B" alt="Quota coverage">
...
The [current coverage audit](docs/quota-coverage-progress.md) records 5,095 of
12,081 catalog quotas with an implemented measurement method (42.17%), including
official metrics, which is 72.15% of the 7,062 measurable quotas. It also lists
