...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/coverage-71.04%25%20of%20measurable%20quotas-3DBF9B" alt="Quota coverage">
...
| --- | ---: | --- |
| countable | 845 | the name describes a count; whether an API exposes that inventory has to be checked quota by quota |
...
The [current coverage audit](docs/quota-coverage-progress.md) records 5,017 of
12,081 catalog quotas with an implemented measurement method (41.53%), including
official metrics, which is 71.04% of the 7,062 measurable quotas. It also lists
