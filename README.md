...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,717 of
12,081 catalog quotas with an implemented measurement method (39.04%), including
official metrics, which is 53.98% of the 8,739 measurable quotas. It also lists
