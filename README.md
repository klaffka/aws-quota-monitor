...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,830 of
12,081 catalog quotas with an implemented measurement method (39.98%), including
official metrics, which is 68.19% of the 7,083 measurable quotas. It also lists
