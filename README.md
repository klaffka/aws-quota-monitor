...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,907 of
12,081 catalog quotas with an implemented measurement method (40.62%), including
official metrics, which is 69.43% of the 7,068 measurable quotas. It also lists
