...
The [current coverage audit](docs/quota-coverage-progress.md) records 4,850 of
12,081 catalog quotas with an implemented measurement method (40.15%), including
official metrics, which is 68.62% of the 7,068 measurable quotas. It also lists
